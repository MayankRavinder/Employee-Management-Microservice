...
public abstract class AbstractController {
	...
	protected <T> ResponseEntity<T> getResponse(final T entity, final HttpHeaders httpHeaders,
	...
	private <T> ResponseEntity<T> buildResponseEntity(final T entity, HttpHeaders httpHeaders,
			final HttpStatus status) {
		if (httpHeaders == null) {
